...
<body class="bg-gray-100 font-sans leading-normal tracking-normal flex items-center justify-center min-h-screen">
    ...
    <div class="container mx-auto mt-10 p-6 bg-white rounded-lg shadow-xl max-w-md">
        ...
        <form id="edit-task-form" action="/tasks/<?= htmlspecialchars($task->id) ?>/update" method="POST" class="space-y-4">
            <div>
            ...
            <div class="flex justify-between items-center">
                <a href="/tasks/<?= htmlspecialchars($task->id) ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out">
                    Cancelar
                </a>
